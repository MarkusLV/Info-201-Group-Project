...
p("A few possible limitation to be considered in the data set are people lying about not having a mental disability because they are ashamed of it. Another possible limitation to consider is the purpose of the screen time for example work, games, social media, etc. Lastly the final limitation to be considered in our data collection would be the promiscuity of mental health as there are varying types of mental disorders. For the purposes of this research, the mental illnesses we have recorded are schizophrenia, bipolar disorder, eating disorder, anxiety disorder, drug addiction disorder, alcohol addiction disorder, and depression.
"),
                         
                         
h1(
tags$img(src = 'x.png', height = 350, width = 450)
  ),
...
conclusion_tab <- tabPanel("Conclusion",
                           ...
                           h1(
                             tags$img(src = 'z.png', height = 350, width = 500)
                           )                    
                           )
